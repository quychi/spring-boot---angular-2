...
export class ApiService {
  ...
  getAllRouteApi: string = "routes";
  getAllCarApi: string = "cars";
  getCarByRouteIdApi: string= "carByRouteId";
  getBookingApi: string="booking";
  ...
  getAllRoute(): Observable<HttpResponse<any>> {
    var headers = new HttpHeaders({
      'Content-Type': "application/json",
    })
    var tokenHttpOptions = {
    ...
    return this.http.get<HttpResponse<any>>(this.domain + this.getAllRouteApi, tokenHttpOptions);
  }
  getAllCars(): Observable<HttpResponse<any>> {
    var headers = new HttpHeaders({
      'Content-Type': "application/json",
    })
    var tokenHttpOptions = {
    ...
    return this.http.get<HttpResponse<any>>(this.domain + this.getAllCarApi, tokenHttpOptions);
  }
  getCarRequestByRouteId(id: number, token: string): Observable<HttpResponse<any>> {
    var headers = new HttpHeaders({
      'Content-Type': "application/json",
      'Authorization': "Token " + token
    })
    ...
    return this.http.get<HttpResponse<any>>(this.domain + this.getCarByRouteIdApi, tokenHttpOptions);
  }
  addBooking(idRoute: number, idNote: number, idCar: number, b: Booking, token: string): Observable<HttpResponse<any>> {
    var headers = new HttpHeaders({
      'Content-Type': "application/json",
      'Authorization': "Token " + token
    })
    var tokenHttpOptions = {
      headers: headers,
      params: new HttpParams().append("idRoute", idRoute.toString())
        .append("idNote", idNote.toString())
        .append("idCar", idCar.toString())

    }
    return this.http.post<HttpResponse<any>>(this.domain + this.getBookingApi, b, tokenHttpOptions);
  }
  deleteBooking(id: number, token: string): Observable<HttpResponse<any>> {
      var headers = new HttpHeaders({
        'Content-Type': "application/json",
        'Authorization': "Token " + token
      })
      ...
      return this.http.delete<HttpResponse<any>>(this.domain + this.getBookingApi, tokenHttpOptions);
  
  }
  addNote( n: Note, token: string): Observable<HttpResponse<any>> {
    var headers = new HttpHeaders({
      'Content-Type': "application/json",
      'Authorization': "Token " + token
    })
    ...
    return this.http.post<HttpResponse<any>>(this.domain + `note`, n, tokenHttpOptions);
  }

  // nguyen ban origin code ANGULAR TEAM
