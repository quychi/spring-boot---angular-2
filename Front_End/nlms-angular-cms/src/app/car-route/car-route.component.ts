...
@Component({
  ...
  styleUrls: ['./car-route.component.css']
})
export class CarRouteComponent implements OnInit {
  ...
  //   //  reload data after change (call get api again)
  //   this.http.get(this.url,this.httpOptions).subscribe(
  //     res =>{var d : any = res;
  //     this.dataArr = d.data;
  //    console.log(this.dataArr)},
  ...
  //   this.contact.status = this.selectedValue;       //[(ngModel)] hon?
  //   // ... do other stuff here ...
  // }
  ...
  //   // }
  //     this.http.post(this.api+`add-contact/`,this.contact,this.httpOptions).subscribe
  //     (res =>{console.log(res);},
  ...
  // onClickFix(contact: Contact)
  // {
  //   console.log("aaaaaFixContact");
  ...
  //   //   //"created_date":post.created_date
  //   // }
  //     this.http.put(this.api+`contacts/`+this.contact.id,this.contact,this.httpOptions).subscribe
  //     (res =>{console.log(res);},
